...
let s:p.normal.left     = [ [ s:foreground, s:green ], [ s:foreground, s:purple_light ], [ s:foreground, s:statusline_active_bg ] ]
...
let s:p.insert.left     = [ [ s:foreground, s:blue ], [ s:foreground, s:purple_light ], [ s:foreground, s:statusline_active_bg ] ]
let s:p.insert.right    = s:p.insert.left

let s:p.replace.left    = [ [ s:foreground, s:pink ], [s:foreground, s:purple_light ], [ s:foreground, s:statusline_active_bg ] ]
let s:p.replace.right   = s:p.replace.left

let s:p.visual.left     = [ [ s:foreground, s:purple ], [s:foreground, s:purple_light ], [ s:foreground, s:statusline_active_bg ] ]
