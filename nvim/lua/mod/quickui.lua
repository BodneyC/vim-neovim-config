...
M.init = function()
  ...
  vim.fn['quickui#menu#install']('&Options', {
    ...
    { '&Sub Once',        'call feedkeys(":s//" . input("Replace term: ") . "/\x13")',   'Replace your previous search' },
    { 'Sub L&ine',        'call feedkeys(":s//" . input("Replace term: ") . "/g\x13")',  'Replace your previous search' },
    { 'Sub &All',         'call feedkeys(":%s//" . input("Replace term: ") . "/g\x13")', 'Replace your previous search' },
    { '-',                ''                                                              },
  ...
  skm('n', '<RightMouse>', "<LeftMouse>:call quickui#context#open(g:context_opts, { 'index': g:quickui#context#cursor })<CR>", { silent = true })
  skm('n', '<M-0>', ":call quickui#context#open(g:context_opts, { 'index': g:quickui#context#cursor })<CR>", { silent = true })
  skm('n', '<Leader><Leader>', ':call quickui#menu#open()<CR>', { silent = true, noremap = true })
