...
skm('n', '<A-s>',     '<CMD>w<CR>',                  { noremap = true, silent = true })
...
skm('n', '<M-b>', '<CMD>BufferPick<CR>',         { noremap = true, silent = true })
skm('n', '<M-1>', '<CMD>BufferGoto 1<CR>',       { noremap = true, silent = true })
skm('n', '<M-2>', '<CMD>BufferGoto 2<CR>',       { noremap = true, silent = true })
skm('n', '<M-3>', '<CMD>BufferGoto 3<CR>',       { noremap = true, silent = true })
skm('n', '<M-4>', '<CMD>BufferGoto 4<CR>',       { noremap = true, silent = true })
skm('n', '<M-5>', '<CMD>BufferGoto 5<CR>',       { noremap = true, silent = true })
skm('n', '<M-6>', '<CMD>BufferGoto 6<CR>',       { noremap = true, silent = true })
skm('n', '<M-7>', '<CMD>BufferGoto 7<CR>',       { noremap = true, silent = true })
skm('n', '<M-8>', '<CMD>BufferGoto 8<CR>',       { noremap = true, silent = true })
skm('n', '<M-9>', '<CMD>BufferGoto 9<CR>',       { noremap = true, silent = true })
skm('n', '<M-<>', '<CMD>BufferMovePrevious<CR>', { noremap = true, silent = true })
skm('n', '<M->>', '<CMD>BufferMoveNext<CR>',     { noremap = true, silent = true })
...
skm('n', '<leader>bd', '<CMD>Bclose<CR>',            { noremap = true, silent = true })
skm('n', '<A-w>',      '<CMD>Bclose<CR>',   { noremap = true, silent = true })
...
skm('n', '<leader>i', "<CMD>lua require'utl.util'.toggle_bool_option('o', 'ignorecase')<CR>", { noremap = true, silent = true })
